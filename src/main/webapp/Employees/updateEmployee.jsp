    ...
    <body>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Update Employee</h4>              
                    <form name="form1" method="post" action="../imguploadServlet" enctype="multipart/form-data">
