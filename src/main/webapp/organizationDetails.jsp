    ...
    <body>
        <div class="bs-example">
          ...
          <div class="container">
              <div class="card-deck">
            <div class="card">
                <img class="img-thumbnail img-responsive" src="showOrgImage.jsp?id=<%=rs.getString("org_name")%>" alt="Card image" style="width:100%">
            </div>
            <div class="card">
                ...
                <br>
                <h5 class="text-center"><b>Organization name:</b> <%=rs.getString("org_name")%></h5>
                <h5 class="text-center"><b>Address:</b> <%=rs.getString("org_address")%></h5>
                <h5 class="text-center"><b>Contact:</b> <%=rs.getString("org_contact")%></h5>
                <h5 class="text-center"><b>Description:</b> <%=rs.getString("org_description")%></h5>
                <br>
                <p class="text-center"><a href="Schools/schoolList.jsp?id=<%=rs.getString("org_name")%>" class="btn btn-danger btn-block">All Schools under <%=rs.getString("org_name")%></a></p>
