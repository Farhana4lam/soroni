            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h2 class="card-title mt-3 text-center" style="color: #35394c;">Registration Form</h2>
                    <form action="../RegisterForEventServlet" method="post">
                            <select name="event" class="custom-select custom-select mb-3" required>
                                <option>Event</option>
                            ...
                            <%
                                ...
                                String sqlStr = "select event_id,event_name from events";
                                ResultSet rs = st.executeQuery(sqlStr);
                                while(rs.next()) 
                                {
                                %>
                                <option value="<%=rs.getString("event_id")%>"><%=rs.getString("event_name")%></option>
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
                    ...
                    <div class="form-group">
                            <button type="submit" class="btnn btn-block"><i class="fa fa-plus"> Register</i></button>
    </div>
                        <div class="form-group">
                            <button type="reset" class="btnn btn-block"><i class="fa fa-undo"> Reset</i></button>
    </div>
                                <div class="form-group">
            <p class="text-center"><a href="addVolunteer.jsp" class="btnn btn-block">Back</a></p>
                   </div>
                    </form>
            </article>
            </div>
