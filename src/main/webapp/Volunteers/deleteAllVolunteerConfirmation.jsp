...
Statement st = conn.createStatement();
                    ...
                    String sqlStr = "select * from events where event_id = '"+id+"'";
                    ResultSet rs = st.executeQuery(sqlStr);
                    while(rs.next()) 
                    {
                    %>
                    <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete all volunteers from <%=rs.getString("event_name")%> event?</h3>
                    
                    <br><br><br>
                    <p class="text-center"><a href="../DeleteAllVolunteerServlet?id=<%=rs.getString("event_id") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
