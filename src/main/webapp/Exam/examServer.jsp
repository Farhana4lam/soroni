    ...
    <body>
      ...
      <div class="container-sm" style="height: 400px;">
        ...
        <%
            ...
            String correct_ans[]= new String[6];
            for(int j=0;j<6;j++){
            correct_ans[j]=request.getParameter("correct_ans"+j);
            System.out.println(correct_ans[j]);
            }
            int count=0;
            for(int i=0;i<correct_ans.length;i++){
            if((correct_ans[i]!=null)&&(ans[i]!=null)){
            ...
            %>
            <h2 class="card-title mt-3 text-center" style="color: red;">You got <%=count%> marks!</h2>
            
            <br>
            <p class="text-center"><a href="mcqExam.jsp" class="btn btn-block btn-danger">Give Another Exam</a></p>
            <p class="text-center"><a href="../index.jsp" class="btn btn-block btn-dark">End Exam</a></p>
            </article>
            </div>
        </div>
