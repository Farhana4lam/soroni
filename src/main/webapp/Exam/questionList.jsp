    ...
    <body>
        ...
        <%
                try{
                    ...
                    String sqlStr = "select * from exam where class ='"+class_no+"' and subject = '"+subject+"'";
                    ...
                    <tr>
                        <td><%=rs.getString("question_no")%></td>
                        <td><%=rs.getString("question_name")%></td>
                        <td><%=rs.getString("option1")%></td>
                        <td><%=rs.getString("option2")%></td>
                        <td><%=rs.getString("option3")%></td>
                        <td><%=rs.getString("option4")%></td>
                        <td><%=rs.getString("correct_ans")%></td>
                        <td><a href="updateQuestion.jsp?id=<%=rs.getString("exam_id")%>" class="btn btn-dark"><i class="fa fa-edit"></i></a></td>
                        <td><a href="deleteQuestionConfirmation.jsp?id=<%=rs.getString("exam_id")%>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                    </tr>
