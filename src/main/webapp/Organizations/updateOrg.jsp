...
try{
        ...
        ResultSet rs=st.executeQuery("select * from organization where org_name='"+name+"'");
        while(rs.next()){
%>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Update Organization</h4>
                <form action="../UpdateOrgServlet" method="post">
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("org_name")%>" name="org_name" class="form-control" required>
                   </div>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-address-card"></i> </span>
		 </div>
                   <input type="text" value="<%=rs.getString("org_address")%>" name="org_address" class="form-control" required>
                   </div>
                    <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-phone"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("org_contact")%>" name="org_contact" class="form-control" required>
                    </div>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-align-justify"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("org_description")%>" name="org_description" class="form-control"> 
                   </div>
