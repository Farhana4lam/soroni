...
try{
        ...
        ResultSet rs=st.executeQuery("select * from events where event_id='"+id+"'");
        while(rs.next()){
%>
    ...
    <body>
        ...
        <div class="container">
            <center>
                ...
                <h2 class="card-title mt-3 text-center" style="color: #35394c;">Event Details</h2> 
                <br>
                <h5>Event ID: <%=rs.getString("event_id")%></h5>
                <h5>Name: <%=rs.getString("event_name")%></h5>
                <h5>Address: <%=rs.getString("event_address")%></h5>
                <h5>Location: <%=rs.getString("event_location")%></h5>
                <h5>Date: <%=rs.getString("event_date")%></h5>
                <h5>Time: <%=rs.getString("event_time")%></h5>
                <h5>Organization: <a href="../Organizations/orgDetails.jsp?id=<%=rs.getString("organization_org_name")%>" class="btn btn-danger"><i class="fa fa-eye"> <%=rs.getString("organization_org_name")%></i></a></h5>
                <h5>Description: <%=rs.getString("event_description")%></h5>
                <p class="text-center"><a href="manageStudent.jsp" class="btn btn-dark btn-block">Back</a></p>
                    </article>
                </div>
