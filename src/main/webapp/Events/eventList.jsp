    ...
    <body>
        ...
        <%
                try{
                    ...
                    String sqlStr = "select * from events where organization_org_name ='"+name+"'";
                ...
                <a href="deleteAllEventsConfirmation.jsp?id=<%=name%>" class="btn btn-danger"><i class="fa fa-trash"> Delete All</i></a>
                <a href="../Organizations/manageOrg.jsp" class="btn btn-dark">Back</a>
       </div>
