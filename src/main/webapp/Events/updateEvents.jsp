...
try{
        ...
        ResultSet rs=st.executeQuery("select * from events where event_id='"+event_id+"'");
        while(rs.next()){
%>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Update Events</h4>
                    <form action="../updateEventServlet" method="post">
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-key"></i> </span>
		 </div>
                       <input type="text" value="<%=rs.getString("event_id")%>" name="ID" class="form-control" readonly required> 
                   </div>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-key"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("event_name")%>" name="name" class="form-control" required>
                   </div>
                   <div class="form-row">
                       <div class="col">
                           <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-address-card"></i> </span>
                        ...
                        <input type="text" value="<%=rs.getString("event_address")%>" name="address" class="form-control" required>
                           </div>
                       </div>
                   <div class="col">
                       <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-location-arrow"></i></span>
                        ...
                        <input type="text" value="<%=rs.getString("event_location")%>" name="location" class="form-control" required>
                       </div>
                   </div>
                   </div>
                       <div class="form-row">
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-calendar"></i></span>
                        ...
                        <input type="text" value="<%=rs.getString("event_date")%>" name="date" id="datepicker" class="form-control" required>
                               </div>
                           </div>
                           <div class="col">
                               <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-clock-o"></i></span>
                        ...
                        <input type="text" value="<%=rs.getString("event_time")%>" name="time" id="time" class="form-control" required>
                               </div>
                           </div>
                       </div>
                               <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-align-justify"></i></span>
                        ...
                        <input type="text" value="<%=rs.getString("event_description")%>" name="description" class="form-control"> 
                               </div>
                        <select name="event_org" class="custom-select custom-select mb-3" required>
                            <option><%=rs.getString("organization_org_name")%></option>
                            <%
                                try{
                                Statement st1=con.createStatement();
                                String sqlStr = "select distinct org_name from organization";
                                ResultSet rs1 = st1.executeQuery(sqlStr);
                                while(rs1.next()) 
                                {
                                %>
                                <option value="<%=rs1.getString("org_name")%>"><%=rs1.getString("org_name")%></option>
                    ...
                    <select name="countdown" class="custom-select custom-select mb-3" required>
                        <option><%=rs.getString("countdown")%></option>
                    </select>
                            
                   <div class="form-group">
                            <button type="submit" class="btnn btn-block"><i class="fa fa-edit"> Update</i></button>
    </div>
                    <div class="form-group">
            <p class="text-center"><a href="manageEvents.jsp" class="btnn btn-block">Back</a></p>
                   </div>
                </form>
            </article>
                </div>
