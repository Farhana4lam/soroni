...
Statement st = conn.createStatement();
                    ...
                    {
                    %>
                    <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete the value for <%=rs.getString("event_name")%>?</h3>
                    
                    <br><br><br>
                    <p class="text-center"><a href="../DeleteEventServlet?id=<%=rs.getString("event_id") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
                    <p class="text-center"><a href="manageEvents.jsp" class="btn btn-block btn-success"><i class="fa fa-undo"> No</i></a></p>
                    <% } 
                    conn.close();
