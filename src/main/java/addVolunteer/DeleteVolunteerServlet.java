...
public class DeleteVolunteerServlet extends HttpServlet {
            ...
            try
                {
                  ...
                  int row =  st.executeUpdate("DELETE FROM volunteer WHERE volunteer_email='"+email+"'");
            if (row > 0) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteVolunteerServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
