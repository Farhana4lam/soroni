...
public class DeleteAllEventsServlet extends HttpServlet {
            ...
            try
                {
                  ...
                  int row =  st.executeUpdate("DELETE FROM events WHERE organization_org_name='"+id+"'");
            if (row > 0) {
                String message = "Successfully deleted all events from "+id+" organization";
