...
try
{
                    ...
                    {
                    %>
                    <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete the value for <%=rs.getString("org_name")%> ?</h3>
                    <br><br><br>
                    <p class="text-center"><a href="../DeleteOrgServlet?id=<%=rs.getString("org_name") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
                    <p class="text-center"><a href="manageOrg.jsp" class="btn btn-block btn-success"><i class="fa fa-undo"> No</i></a></p>
