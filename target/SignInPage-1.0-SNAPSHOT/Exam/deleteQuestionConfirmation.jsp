...
String exam_id=request.getParameter("id");
    ...
    Statement st = conn.createStatement();
                        ...
                        String sqlStr = "select * from exam where exam_id = '"+exam_id+"'";
                        ResultSet rs = st.executeQuery(sqlStr);
                        while(rs.next()) 
                        {
                        %>
                        <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete the value for <%=rs.getString("exam_id")%>?</h3>
                        
                        <br><br><br>
                        <p class="text-center"><a href="../DeleteQuestionServlet?id=<%=rs.getString("exam_id") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
                        <p class="text-center"><a href="manageExam.jsp" class="btn btn-block btn-success"><i class="fa fa-undo"> No</i></a></p>
                        <% } 
                        conn.close();
