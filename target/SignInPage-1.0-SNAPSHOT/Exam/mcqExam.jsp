...
<html>
    ...
    <body>
        ...
        <div class="container-sm">
            <h1 style="color: red;">Short MCQ Exam</h1>
            <div class="card" style="background-color: #fff1b3;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h2 class="card-title mt-3 text-center" style="color: #35394c;">Select Class and Subject</h2>
        <form action="mcqExamQuestions.jsp" method="post">
