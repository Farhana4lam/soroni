...
<html>
    ...
    <body>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light" style="background-color: white;">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                         ...
                         <div class="collapse navbar-collapse" id="collapsibleNavbar">                    
                            ...
                            <a href="mcqExam.jsp" class="nav-item nav-link"><b>MCQ Exam</b></a>
                            </div>
        ...
        <div class="container-sm">
            <br>
            <a href="addExam.jsp" class="btn btn-danger"><i class="fa fa-plus"> Add New Exam</i></a>
            <br>
         
    <div class="card" style="background-color: white;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Search Questions</h4>
