...
<html>
    ...
    try{
        ...
        ResultSet rs=st.executeQuery("select * from exam where exam_id='"+exam_id+"'");
        while(rs.next()){
%>
<div class="container-sm">
            <div class="card" style="background-color: #c1ffb3;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Edit Questions</h4>       
                    <form action="../updateExamServlet" method="post">
                       <input type="hidden" value="<%=rs.getString("exam_id")%>" name="exam_id"> 
                   <div class="form-group input-group">
                        <input type="text" value="<%=rs.getString("class")%>" name="class" class="form-control" required readonly>    
                   </div>
                   <div class="form-group input-group">
                        <input type="text" value="<%=rs.getString("subject")%>" name="subject" class="form-control" required readonly>
                   </div>
                        <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-list-ol"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("question_no")%>" name="question_no" class="form-control" required readonly>
                        </div>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-bars"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("question_name")%>" name="question_name" class="form-control" required>
                   </div>
                  <div class="form-row">
            <div class="col">
                   <input type="text" value="<%=rs.getString("option1")%>" name="option1" class="form-control" required> 
            </div>
                   <div class="col">  
                   <input type="text" value="<%=rs.getString("option2")%>" name="option2" class="form-control" required>
                   </div>
                  </div>
                   <br>
                  ...
                  <div class="form-row">
            <div class="col">
                   <input type="text" value="<%=rs.getString("option3")%>" name="option3" class="form-control" required> 
            </div>
                   <div class="col">  
                   <input type="text" value="<%=rs.getString("option4")%>" name="option4" class="form-control" required> 
                   </div>
                  </div>
                   <br>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-check"></i> </span>
                        ...
                        <input type="text" value="<%=rs.getString("correct_ans")%>" name="correct_ans" class="form-control" required>
                   </div>
