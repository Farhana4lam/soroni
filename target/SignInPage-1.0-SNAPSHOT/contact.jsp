    ...
    <body>
            ...
            <div class="card-group">
                <div class="card" style="background-color: #c1ffb3;">
                    <div class="card-body text-center">
                        <div class="container" style="background-color: #fff1b3;">
                            <h4>Developed by</h4>
                        <img src="img/avatar1.png" class="img-rounded" alt="card-image" style="width: 100px;">
                        <h5>Farhana Alam</h5>
                        <img src="img/avatar2.png" class="img-rounded" alt="card-image" style="width: 100px;">
                        <h5>Barna Nath</h5>
                        <br>
                        </div>
                        ...
                        <i class="fa fa-map-marker"> Address</i>
                            <p><span>East West University<br>Aftabnagar, Dhaka</p>
                ...
                <div class="card-body">
                    <article class="card-body mx-auto" style="max-width: 400px;">
                      ...
                      <h4 class="card-title mt-3 text-center" style="color: #35394c;">Send Us a Message</h4> 
                      <p class = "update_msg text-center" style="color: red;"><%= request.getAttribute("msg") == null ? "" : request.getAttribute("msg")%> </p>
                      <br>
                      <form name="form1" method="post" action="contactImplement.jsp">
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-at"></i> </span>
                        ...
                        <input type="text" placeholder="example@gmail.com" name="email" class="form-control" required>
                   </div>
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
                    ...
                    <div class="form-group">
                            <button type="submit" class="btn btn-block btn-success"><i class="fa fa-paper-plane"> Send Message</i></button>
                    </div> 
                          </form>
                    </article>
            </div>
