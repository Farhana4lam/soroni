        ...
        <div class="container-sm">
         ...
         <div class="card" style="background-color: #fff1b3; height: 400px; width: 400px;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Select Class</h4>
                    <form action="searchPDF.jsp" method="post">
                        <br><br>
                            ...
                            <%
                                ...
                                String sqlStr = "select distinct class from pdf";
                                ResultSet rs = st.executeQuery(sqlStr);
                                while(rs.next()) 
                                {
                                %>
                                <option value="<%=rs.getString("class")%>">class: <%=rs.getString("class")%></option>
                            ...
                            <button type="submit" class="btnn btn-block"><i class="fa fa-search"> Search</i></button>
    </div>   
                        <div class="form-group">
            <p class="text-center"><a href="index.jsp" class="btnn btn-block">Back</a></p>
                   </div>      
