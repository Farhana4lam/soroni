...
try{
        ...
        ResultSet rs=st.executeQuery("select event_id from events where event_id='"+event_id+"'");
        while(rs.next()){
%>
<!DOCTYPE html>
<html>
    ...
    <body>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light" style="background-color: white;">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                         ...
                         <div class="collapse navbar-collapse" id="collapsibleNavbar">                    
                            ...
                            <a href="../newsandEvents.jsp" class="nav-item nav-link active"><b>News and Events</b></a>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h2 class="card-title mt-3 text-center" style="color: red;">Registration Form</h2>               
                
                    <form action="../RegisterStudentServlet?id=<%=rs.getString("event_id")%>" method="post">
                        <br>
                   <input type="text" name="student_name" placeholder="Name" class="form-control" required>    
                   <br>
                   <input type="text" name="student_age" placeholder="Age" class="form-control" required>
                   <br>
                   <div class="form-group">
                            <button type="submit" class="btn btn-block btn-success"><i class="fa fa-plus"> Register</i></button>
    </div>
                   <div class="form-group">
            <p><a href="../newsandEvents.jsp" class="btn badge-dark">Back</a></p>
                   </div>
