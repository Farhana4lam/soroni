    ...
    <body>
                    ...
                    <nav class="navbar navbar-expand-md navbar-light" style="background-color: white;">
                        ...
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                         ...
                         <div class="collapse navbar-collapse" id="collapsibleNavbar">                    
                            ...
                            <a href="#" class="nav-item nav-link active"><b>What is my token number?</b></a>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h2 class="card-title mt-3 text-center" style="color: red;">Search for Token</h2>
                
               <form action="searchToken-process.jsp" method="post">
                   <br>
                    <input type="text" name="name" placeholder="Name" class="form-control" required>
                    <br>
                     <input type="text" name="age" placeholder="Age" class="form-control" required>
                     <br>
                    <button type="submit" class="btn btn-success btn-block"><i class="fa fa-search"> Search</i></button>
                    <br>
                    <p class="text-center"><a href="../index.jsp" class="btn btn-block btn-dark"><i class="fa fa-home"> Home</i></a></p>
                </form>
            </article>
            </div>
        </div>
