...
<html>
    ...
    <body>
       ...
       <div class="main">
          ...
          <input id="gfg" type="text" placeholder="Search for Student Information" class="form-control">
          </div>
          </div>
        ...
        <%
                try{
                    ...
                    String sqlStr = "select * from attends";
                    ...
                    <tr>
                        ...
                        <td><a href="eventDetails.jsp?id=<%=rs.getString("events_event_id")%>"  class="btn btn-dark"><i class="fa fa-eye"> <%=rs.getString("events_event_id")%></i></a></td>
                    </tr>
