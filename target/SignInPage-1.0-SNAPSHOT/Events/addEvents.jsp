    ...
    <body>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Add a New Event</h4>
                    <form action="../RegisterEventServlet" method="post">
                    <select name="org_name" class="custom-select custom-select mb-3" required>
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-key"></i> </span>
                        ...
                        <input type="text" placeholder="Event ID" name="event_id" class="form-control" required>
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-address-card"></i> </span>
                        ...
                        <input type="text" placeholder="Address" name="event_address" class="form-control" required>
                    </div>
                     </div>
                     <div class="col">
                    <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-location-arrow"></i></span>
                        ...
                        <input type="text" placeholder="Location" name="event_location" class="form-control" required>
                        </div>
                     </div>
                 </div>
            <div class="form-row">
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-calendar"></i></span>
                        ...
                        <input type="text" name="event_date" id="datepicker" placeholder="Date" class="form-control" required>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-clock-o"></i></span>
                        ...
                        <input type="text" id="time" name="event_time" placeholder="Time" class="form-control" required>
                    </div>
                </div>
            </div>
                    <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-align-justify"></i></span>
                        ...
                        <input type="text" placeholder="Description" name="event_description" class="form-control">
                    </div>
                    
                    <select name="countdown" class="custom-select custom-select mb-3" required>
                        <option>Countdown Active?</option>
                        <option>Yes</option>
                        <option>No</option>
                    </select>
