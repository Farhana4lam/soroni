...
Statement st = conn.createStatement();
                    ...
                    String sqlStr = "select * from organization where org_name = '"+id+"'";
                    ResultSet rs = st.executeQuery(sqlStr);
                    while(rs.next()) 
                    {
                    %>
                    <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete all events from <%=rs.getString("org_name")%> organization?</h3>
                    
                    <br><br><br>
                    <p class="text-center"><a href="../DeleteAllEventsServlet?id=<%=rs.getString("org_name") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
                    <p class="text-center"><a href="../Organizations/manageOrg.jsp" class="btn btn-block btn-success"><i class="fa fa-undo"> No</i></a></p>
