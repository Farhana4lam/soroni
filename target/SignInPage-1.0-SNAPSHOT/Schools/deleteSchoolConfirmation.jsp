...
Statement st = conn.createStatement();
                    ...
                    String sqlStr = "select schools_id,school_name from schools where schools_id = "+id;
                    ResultSet rs = st.executeQuery(sqlStr);
                    while(rs.next()) 
                    {
                    %>
                    <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete the value for <%=rs.getString("school_name")%> ?</h3>
                    
                    <br><br><br>
                    <p class="text-center"><a href="../DeleteSchoolServlet?id=<%=rs.getString("schools_id") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
                    <p class="text-center"><a href="manageSchool.jsp" class="btn btn-block btn-success"><i class="fa fa-undo"> No</i></a></p>
