...
<html>
    ...
    <div class="container">
        <a href="addSchool.jsp" class="btn btn-danger"><i class="fa fa-plus"> Add New School</i></a>
        <div class="main">
                 <div class="form-group has-search">
                     <span class="fa fa-search form-control-feedback"></span>
          <input id="gfg" type="text" placeholder="Search for School Information" class="form-control">
          </div>
          </div>
            ...
            <%
                try{
                    ...
                    <tr>
                        ...
                        <td><%=rs.getString("schools_id")%></td>
                        <td><%=rs.getString("school_name")%></td>
                        <td><%=rs.getString("class")%></td>
                        <td><%=rs.getString("school_start_time")%></td>
                        <td><%=rs.getString("school_end_time")%></td>
                        <td><%=rs.getString("school_add")%></td>
                        <td><%=rs.getString("organization_org_name")%></td>
                        <td><a href="updateSchool.jsp?s_id=<%=rs.getString("schools_id")%>" class="btn btn-dark"><i class="fa fa-edit"></i></a></td>
                        <td><a href="deleteSchoolConfirmation.jsp?id=<%=rs.getString("schools_id") %>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                    </tr>
