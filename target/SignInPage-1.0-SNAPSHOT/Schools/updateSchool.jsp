...
try{
        ...
        ResultSet rs=st.executeQuery("select * from schools where schools_id='"+id+"'");
        while(rs.next()){
%>
<!DOCTYPE html>
<html>
    ...
    <body>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Update School</h4>
                    <form action="../UpdateSchoolServlet" method="post">
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-key"></i> </span>
		 </div>
                       <input type="text" value="<%=rs.getString("schools_id")%>" name="ID" class="form-control" readonly required> 
                   </div>
                  <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
                   <input type="text" value="<%=rs.getString("school_name")%>" name="name" class="form-control" required>
                  </div>
                   <div class="form-row">
                       <div class="col">
                           <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-clock-o"></i></span>
                        ...
                        <input type="text" value="<%=rs.getString("school_start_time")%>" name="school_start_time" id="time" class="form-control" required>
                           </div>
                       </div>
                   <div class="col">
                           <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-clock-o"></i></span>
                        ...
                        <input type="text" value="<%=rs.getString("school_end_time")%>" name="school_end_time" id="time" class="form-control" required>
                           </div>
                   </div>
                        </div>
                   <div class="form-row">
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-address-card"></i> </span>
                        ...
                        <input type="text" value="<%=rs.getString("school_add")%>" name="address" class="form-control" required> 
                           </div>
                       </div>
                    <div class="col">
                        <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-location-arrow"></i> </span>
                        ...
                        <input type="text" value="<%=rs.getString("school_area")%>" name="area" class="form-control" required>
                        </div>
                    </div>
                   </div>
                    <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-list-ol"></i> </span>
                        ...
                        <input type="text" value="<%=rs.getString("class")%>" name="class" class="form-control" required> 
                    </div>
                   ...
                   <div class="form-group">
                       <button type="submit" class="btnn btn-block"><i class="fa fa-edit"> Update</i></button></div>
                        <div class="form-group">
