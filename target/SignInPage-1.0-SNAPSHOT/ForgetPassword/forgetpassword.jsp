  ...
  <div class="container-sm">
      <div class="card" style="background-color: #fff1b3; height: 400px;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h3 class="card-title mt-3 text-center" style="color: #35394c;">Reset Password</h3>
      
        <form action="forgetPasswordEmail.jsp" method="post">
            <br><br>
            <div class="form-group input-group">
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-id-badge"></i> </span>
		 </div>
                    <input type="text" placeholder="User ID" name="ID" class="form-control" required>
            </div>
            <div class="form-group">
        <button type="submit" class="btn btn-block btn-danger">Enter</button>
    </div>
                    
                    
                    <p class="text-center"><a href="../login.jsp" class="btn btn-block btn-dark">Back to Login Page</a></p>
        </form>
            </article>
      </div>
  </div>
