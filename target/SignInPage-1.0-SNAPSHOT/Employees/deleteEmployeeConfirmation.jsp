...
Statement st = conn.createStatement();
                    ...
                    String sqlStr = "select employee_id,employee_name from employee where employee_id = "+id;
                    ResultSet rs = st.executeQuery(sqlStr);
                    while(rs.next()) //loop will continue until it gets all the value
                    {
                    %>
                    <h3 class="card-title mt-3 text-center" style="color: red;">Do You want to Delete all information about <%=rs.getString("employee_name")%>?</h3>
                    
                    <br><br><br>
                    <p class="text-center"><a href="../DeleteEmployeeServlet?id=<%=rs.getString("employee_id") %>" class="btn btn-block btn-danger"><i class="fa fa-trash"> Yes</i></a></p>
                    <p class="text-center"><a href="manageEmployee.jsp" class="btn btn-block btn-success"><i class="fa fa-undo"> No</i></a></p>
