...
<div class="container-sm">
    <div class="card" style="background-color: #fff1b3;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Edit Picture</h4>
              <form name="form1" method="post" action="../EditPictureServlet" enctype="multipart/form-data">
		...
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-image"></i> </span>
                ...
                <button type="submit" class="btnn btn-block"><i class="fa fa-upload"> Update</i></button>
