    ...
    <body>
        ...
        <div class="container-sm">
            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Add New Employee</h4>
                    <form name="form1" method="post" action="../RegisterEmployeeServlet" enctype="multipart/form-data">
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-id-badge"></i> </span>
		 </div>
                        <input type="text" placeholder="Employee ID" name="ID" class="form-control" required> 
                   </div>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		...
		<div class="input-group-prepend">
		    ...
		    <span class="input-group-text"> <i class="fa fa-image"></i> </span>
                   ...
                   <div class="form-group">
                        ...
                        <div class="form-group">
            <p class="text-center"><a href="manageEmployee.jsp" class="btnn btn-block">Back</a></p>
                   </div>
