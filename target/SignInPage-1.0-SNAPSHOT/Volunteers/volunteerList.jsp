    ...
    <body>
        ...
        <%
                try{
                    ...
                    String sqlStr = "select * from volunteers,volunteer where events_event_id ='"+id+"' and volunteer_email = volunteer_volunteer_email";
                    ...
                    <tr>
                        ...
                        <td><%=rs.getString("events_event_id")%></td>
                ...
                <a href="deleteAllVolunteerConfirmation.jsp?id=<%=id%>" class="btn btn-danger"><i class="fa fa-trash"> Delete All</i></a>
