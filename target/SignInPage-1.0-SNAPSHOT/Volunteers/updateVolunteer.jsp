...
try{
        ...
        ResultSet rs=st.executeQuery("select * from volunteer where volunteer_email='"+email+"'");
        while(rs.next()){
%>
        ...
        <div class="container-sm">
           <div class="card" style="background-color: #c1ffb3;">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center" style="color: #35394c;">Update Volunteer Info</h4>           
                    <form action="../UpdateVolunteerServlet" method="post">  
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
                   <input type="text" value="<%=rs.getString("volunteer_name")%>" name="volunteer_name" class="form-control" required>
                   </div>
                   <p><div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("volunteer_age")%>" name="volunteer_age" class="form-control" required>
                   </div>
                   <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-phone"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("volunteer_phone")%>" name="volunteer_phone" class="form-control" required>
                   </div>
                    <div class="form-group input-group" >
		<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
		 </div>
                        <input type="text" value="<%=rs.getString("volunteer_email")%>" name="volunteer_email" class="form-control" required> 
                    </div>
                   <div class="form-group">
                       <button type="submit" class="btnn btn-block"><i class="fa fa-edit"> Update</i></button></div>
                       <div class="form-group">
            <p class="text-center"><a href="manageVolunteer.jsp" class="btnn btn-block">Back</a></p>
                   </div>
                </form>
            </article>
</div>
