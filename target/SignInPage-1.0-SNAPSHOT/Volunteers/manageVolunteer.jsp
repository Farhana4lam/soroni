    ...
    <body>
       ...
       <div class="bs-example">
        ...
        <div class="container">                 
          ...
          <input id="gfg" type="text" placeholder="Search for Volunteer Information" class="form-control">
          </div>
          </div>
        ...
        <tbody id="search">
            ...
            <%
                try{
                    ...
                    String sqlStr = "select * from volunteer";
                    ...
                    <tr>
                        ...
                        <td><%=rs.getString("volunteer_age")%></td>
                        <td><%=rs.getString("volunteer_phone")%></td>
                        <td><%=rs.getString("volunteer_email")%></td>
                        <td><a href="updateVolunteer.jsp?mail=<%=rs.getString("volunteer_email")%>" class="btn btn-dark"><i class="fa fa-edit"></i></a></td>
                        <td><a href="deleteVolunteerConfirmation.jsp?mail=<%=rs.getString("volunteer_email") %>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                    </tr>
